...
#맨 윗줄
btn_f16 = Button(root, text = 'F16', width = 5, height = 2) #버튼여백 조절
btn_f17 = Button(root, text = 'F17', width = 5, height = 2)
btn_f18 = Button(root, text = 'F18', width = 5, height = 2)
btn_f19 = Button(root, text = 'F19', width = 5, height = 2)

btn_f16.grid(row = 0, column = 0, sticky = N+E+W+S, padx = 3, pady = 3) #동서남북 방향으로 꽉 채워라
...
btn_0.grid(row = 5, column = 0, columnspan = 2, sticky = N+E+W+S, padx = 3, pady = 3)#현재위치로부터 오른쪽으로 한칸 더함
